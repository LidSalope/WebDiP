...
class Baza {
    ...
    const korisnik = "WebDiP2017x132";
    const lozinka = "admin_Sbf5";
    const baza = "WebDiP2017x132";
    ...
    function spojiDB() {
        ...
        if ($this->veza->connect_errno) {
            echo "Neuspjesno spajanje na bazu: " . $this->veza->connect_errno . ", " .
            $this->veza->connect_error;
            $this->greska = $this->veza->connect_error;
        }
        $this->veza->set_charset("utf8");
        if ($this->veza->connect_errno) {
            echo "NeuspjeĹˇno postavljanje znakova za bazu: " . $this->veza->connect_errno . ", " .
            $this->veza->connect_error;
            $this->greska = $this->veza->connect_error;
        }
        return $this->veza;
    ...
    function selectDB($upit) {
        ...
        if ($this->veza->connect_errno) {
            echo "GreĹˇka kod upita: {$upit} - " . $this->veza->connect_errno . ", " .
            $this->veza->connect_error;
            $this->greska = $this->veza->connect_error;
        }
        if (!$rezultat) {
